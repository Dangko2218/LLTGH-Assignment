...
public class OrderPickupOrDeliveryAndPayment {
    ...
    public InvListInterface<Order> readOrderDatList() {
        ...
        java.util.List priceList = new ArrayList();
        java.util.List subtotalList = new ArrayList();
        java.util.List descList = new ArrayList();
    ...
    public java.util.List convertToPriceList(String s3) {
    ...
    public java.util.List convertToSubtotalList(String s4) {
    ...
    public java.util.List convertToDescList(String s5) {
